...
/**
 * this returns a single {@link DataSource db} that in turn loads its DataSources dynamically from a registry
 * populated by information from the local Docker instance. We could as easily use soemthing like Eureka,
 * Consul, LDAP, etc.
 */
@Component
class DockerComposeTenantAwareDataSourceSupplier
    ...
    DockerComposeTenantAwareDataSourceSupplier(
